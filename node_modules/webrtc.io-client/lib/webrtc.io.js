...
(function() {
  ...
  // Store user information (e.g. order of users joining room)
  rtc.users = {};
  ...
  rtc.connect = function(server, room) {
    ...
    rtc._socket.onopen = function() {
	  ...
	  rtc.storeUserData = function(data) {
		for (var n = 0; n < data.room.length; n ++) {
		  var userId = data.room[n];
		  rtc.users[userId] = {
		  	id: userId,
		  	index: n
		  };
      ...
      rtc.on('get_peers', function(data) {
        ...
        rtc._me.id = data.you;
        if (rtc.attemptOffer) { // 'ready' was fired before 'get_peers'
          rtc.createPeerConnections();
          rtc.addStreams();
          rtc.addDataChannels();
          rtc.sendOffers();
        }
        // place user information in rtc.users
        rtc.storeUserData(data);
